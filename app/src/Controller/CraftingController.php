...
class CraftingController extends BaseController
{
    ...
    public function get($id) {
        $craft = RedFactory::GetRedCrafting()->getById($id);
        if (empty($craft))
            $this->generateResponse("Missing id",404);
        else {
            $craftId = $craft->id;
    ...
    public function all($request, $response, array $args) {
        ...
        if (empty($crafts)) {
            ...
            $this->generateResponse($crafts);
            //echo json_encode(Common::GenerateResponse(Common::STATUS_SUCCESS,Common::ConvertBeanToArray($crafts,"crafts")));
        }
    }
    ...
    private function addAll()
    {
        ...
        $this->generateResponse("Crafts have been reset");
    }
    ...
    private function addMinstrel() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19646,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19746,250);//Bolt of Gossamer
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19665,1);//Gift of the Nobleman
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17274,500);//Seal of Beetletun

            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24522,100);//Opal Orb
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19685,250);//Orichalcum Ingot
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24277,250);//Pile of Crystalline Dust
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24276,250);//Pile of Incandescent Dust
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24275,250);//Pile of Luminous Dust
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24274,250);//Pile of Radiant Dust

            //Icy Runestone
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,19676,100);
            //Superior Sigil of Energy
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24607,1);

        //The Bard
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29168,1);
    }
    ...
    private function addDreamer() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19660,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24512,100);//Chrysocola Orb
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19667,1);//Gift of Thorns
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17273,500);//Deadly Bloom
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24571,1);

        //The Lover
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29178,1);
    }
    ...
    private function addSunrise() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19647,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24305,100);//Charged Lodestone
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19664,1);//Gift of Ascalon
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,16982,500);//Ascalonian Tear
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24562,1);

        //Dawn
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29169,1);
    }
    ...
    private function addRodgort() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19656,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24325,100);//Destroyer Lodestone
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19668,1);//Gift of Baelfire
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17275,500);//Flame Legion Charr Carving

            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,12479,250);//Ghost Pepper
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24315,100);//Molten Lodestone
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24548,1);

        //Rodgort's Flame
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29182,1);
    }
    ...
    private function addQuip() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19651,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,20000,5);//Evon Gnashblade's Box o' Fun
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19685,250);//Orichalcum Ingot
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24592,1);

        //Chaos Gun
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29174,1);
    }
    ...
    private function addMoot() {
        ...
        //The Energizer
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29173,1);
    }
    ...
    private function addMeteorlogicus() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19652,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19732,250);//Hardened Leather Section
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19685,250);//Orichalcum Ingot
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24554,1);

        //Storm
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29176,1);
    }
    ...
    private function addKudzu() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19644,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19737,250);//Cured Hardened Leather Square
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,12128,250);//Omnomberry
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24865,1);

        //Leaf of Kudzu
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29172,1);
    }
    ...
    private function addKraitkin() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19658,1);
            ...
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17270,500);//Manifesto of the Moletariate

            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19737,250);//Cured Hardened Leather Square
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19685,150);//Orichalcum Ingot
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24632,1);

        //Venom
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29183,1);
    }
    ...
    private function addKamohoali() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19657,1);
            ...
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17272,500);//Shard of Zhaitan

            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19685,250);//Orichalcum Ingot
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24295,150);//Vial of Powerful Blood
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24612,1);

        //Carcharias
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29171,1);
    }
    ...
    private function addJuggernaught() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19649,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19688,250);//Steel Ingot
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19666,1);//Gift of the Forgeman
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17270,500);//Manifesto of the Moletariate

            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24502,250);//Silver Doubloon
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24315,150);//Molten Lodestone
        ...
        $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24857,1);

        //The Colossus
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29170,1);
    }
    ...
    private function addIncinerator() {
        ...
        //Spark
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29167,1);
    }
    ...
    private function addHowler() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19662,1);
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24618,1);

        //Howl
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29184,1);
    }
    ...
    private function addFrostfang() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19625,1);
            ...
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24340,1);//Corrupted Lodestone
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19670,1);//Gift of Sanctuary
            $subitem4Id = RedFactory::GetRedCraftSubItem4()->add($subitem3Id,17277,500);//Symbol of Koda

            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24320,100);//Glacial Lonestone
            $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,19685,250);//Orichalcum Ingot
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24555,1);

        //Tooth of Frostfang
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29166,1);
    }
    ...
    private function addFrenzy() {
        ...
        $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24561,1);

        //Rage
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29179,1);
    }
    ...
    private function addFlameseeker() {
        ...
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,19653,1);
            ...
            $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24601,1);

        //The Chosen
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29177,1);
    }
    ...
    private function addBifrost() {
        ...
        $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24522,100);//Opal Orb
        $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,24277,250);//Pile of Crystalline Dust
        $subitem3Id = RedFactory::GetRedCraftSubItem3()->add($subitem2Id,20323,250);//Unidentified Dye
        ...
        $subitem2Id = RedFactory::GetRedCraftSubItem2()->add($subitem1Id,24572,1);

        //Gift of The Bifrost
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29180,1);
    }
    ...
    private function addBolt() {
        ...
        //Zap
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId,29181,1);
    }
    ...
    private function addEternity()
    {
        ...
        //Philosopher's stone
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId, 20796, 10);
        //Pile of Crystalline Dust
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId, 24277, 5);
        //Sunrise
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId, 30703, 1);
        //Twilight
        $subitem1Id = RedFactory::GetRedCraftSubItem1()->add($craftId, 30704, 1);
    }
